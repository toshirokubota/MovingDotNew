...
namespace TK
{
	...
	//enum EdgeType { Tr, Back, Forward, Cross, Path };
	...
	{
	public:
		Edge(Vertex<T>* u = 0, Vertex<T>* v = 0, float w = 0, int type = 0)
		{
			this->u = u;
			this->v = v;
			this->w = w;
	...
	{
	public:
		FlowEdge(Vertex<T>* u = 0, Vertex<T>* v = 0, float w = 0, int type = 0) : Edge<T>(u, v, w, type)
		{
			this->flow = 0;
		}
		virtual ~FlowEdge() {}
